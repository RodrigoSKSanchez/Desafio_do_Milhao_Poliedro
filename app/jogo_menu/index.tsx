  ...
  return (
    <View style={[styles.container, { backgroundColor: tema.fundo }]}>
      <View style={styles.topBar}>
        <Text style={[styles.olaText, { color: tema.texto }]}>
          Olá <Text style={styles.nomeAluno}>{nomeAluno}</Text>
        </Text>

        <TouchableOpacity
          style={[styles.iconButton, { backgroundColor: tema.iconeBg }]}
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.modalBox, { backgroundColor: tema.modalBg }]}>
            <Text style={[styles.modalText, { color: tema.texto }]}>
